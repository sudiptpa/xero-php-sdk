...
final class PayItem extends Model
{
     ...
     */
    public function getEarningsRates(): array
    {
        return $this->earningsRates;
    }
    /**
     * @param list<array<string, mixed>> $earningsRates
     */
    public function setEarningsRates(array $earningsRates): self
    {
     ...
     * @return list<array<string, mixed>>
     */
    public function getDeductionTypes(): array
    {
     ...
     * @param list<array<string, mixed>> $deductionTypes
     */
    public function setDeductionTypes(array $deductionTypes): self
    {
     ...
     * @param list<array<string, mixed>> $leaveTypes
     */
    public function setLeaveTypes(array $leaveTypes): self
    {
     ...
     * @return list<array<string, mixed>>
     */
    public function getReimbursementTypes(): array
    {
     ...
     * @param list<array<string, mixed>> $reimbursementTypes
     */
    public function setReimbursementTypes(array $reimbursementTypes): self
    {
